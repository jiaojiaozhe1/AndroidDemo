...
//        _startAnimation(llTest4, 500, animatorProperty);
        ...
        _startAnimation(llTest6, 300, animatorProperty);
        _startAnimation(llTest7, 400, animatorProperty);
...
//            _closeAnimation(llTest4, 200, bottom);
            ...
            _closeAnimation(llTest7, 300, bottom);
            _closeAnimation(llTest8, 200, bottom);
